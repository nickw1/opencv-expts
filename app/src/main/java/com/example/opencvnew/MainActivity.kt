...
class MainActivity : CameraActivity() {
    ...
    /**
     * A native method that is implemented by the 'opencvnew' native library,
     * which is packaged with this application.
     */
    external fun stringFromJNI(): String

    companion object {
        // Used to load the 'opencvnew' library on application startup.
        init {
            System.loadLibrary("opencvnew")
        }
    }
}